package com.debug61.absolute.common.inventory.container;
...
public class GeneratorContainer extends Container {
    ...
    public GeneratorContainer(int windowId, World level, BlockPos pos, PlayerInventory playerInventory, PlayerEntity player) {
    ...
    public boolean stillValid(PlayerEntity playerIn) {
        return stillValid(IWorldPosCallable.create(tileEntity.getLevel(), tileEntity.getBlockPos()), playerIn, ModBlocks.ABSOLUTE_GENERATOR.get());
    }
